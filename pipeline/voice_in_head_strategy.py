...
class VoiceInHeadStrategy(InterventionStrategy):
    ...
    def apply(self, rollout: str, intervention_text: str, prompt: Optional[str] = None) -> str:
        ...
        voice_in_head_intervened_text = "<think>\n" + clipped_text + "</think><|im_end|>\n<|im_start|>user\n" + f"I interrupted you. Continue, and steer the response towards {intervention_text} within the next 5 sentences<|im_end|>\n<|im_start|>assistant\n" + starter
        ...
        good_intervention = random.choice(good_interventions)
